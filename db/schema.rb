...
ActiveRecord::Schema.define(version: 20170713182400) do
  ...
  create_table "admin_users_pages", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer "page_id"
    t.index ["page_id", "admin_user_id"], name: "index_admin_users_pages_on_page_id_and_admin_user_id", using: :btree
  end
